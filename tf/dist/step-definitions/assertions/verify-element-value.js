      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " contain text: ").concat(expectedElementText, " \u2728"));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " equal text: ").concat(expectedElementText, " \u2728"));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " contain value: ").concat(elementValue, " \u2728"));
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " equal value: ").concat(elementValue, " \u2728"));
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " be enabled \u2728"));
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementPosition, " ").concat(elementKey, " should").concat(negate ? ' not' : '', " contain the text: ").concat(expectedElementText, " \u2728"));
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " ").concat(attribute, " attribute should").concat(negate ? ' not' : '', " contain the text: ").concat(expectedElementText, " \u2728"));
