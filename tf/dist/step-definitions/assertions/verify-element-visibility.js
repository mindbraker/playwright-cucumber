      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " be displayed \u2728"));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementPosition, " ").concat(elementKey, " should").concat(negate ? ' not' : '', " be displayed \u2728"));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(count, " ").concat(elementKey, " should").concat(negate ? ' not' : '', " displayed \u2728"));
