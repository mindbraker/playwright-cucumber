      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " on the ").concat(iframeName, " iframe should").concat(negate ? ' not' : '', " be displayed \u2728"));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " contain the text ").concat(expectedElementText, " \u2728"));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " equal the text: ").concat(expectedElementText, " \u2728"));
