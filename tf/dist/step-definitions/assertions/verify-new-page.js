      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementPosition, " tab | window should").concat(negate ? ' not' : '', " contain the title: ").concat(expectedTitle, " \u2728"));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " on the ").concat(elementPosition, " tab | window should").concat(negate ? ' not' : '', " be displayed \u2728"));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " on the ").concat(elementPosition, " tab | window should").concat(negate ? ' not' : '', " contain the text: ").concat(expectedElementText, " \u2728"));
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " on the ").concat(elementPosition, " tab | window should").concat(negate ? ' not' : '', " equal the text: ").concat(expectedElementText, " \u2728"));
