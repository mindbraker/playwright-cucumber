      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " equal the ").concat(globalVariables[variableKey], " stored in global variables \u2728"));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDD0E ".concat(elementKey, " should").concat(negate ? ' not' : '', " contain the ").concat(globalVariables[variableKey], " stored in global variables \u2728"));
