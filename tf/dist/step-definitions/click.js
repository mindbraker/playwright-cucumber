      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDDB1 Clicking ".concat(ElementKey, " button | link | icon | element"));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _logger.logger.log("\uD83D\uDDB1 Clicking ".concat(elementPosition, " ").concat(elementKey, " button | link | icon | element"));
